<div class="p-6 sm:px-20 bg-white border-b border-gray-200">
    ...
    <div class="mt-8 text-2xl">
        Welcome to your Jetstream application! Super tu a réussie a venir jusque là
    </div>
    ...
    <div class="mt-6 text-gray-500">
        ...
        ecosystem to be a breath of fresh air. We hope you love it. BIENSUR J'AI REUSSIE
    </div>
</div>
